...
void aalsh20_mshai9() {
  printf("By Ali Alshaheen and Muhamamd Shaikah \n");
  printf("Aalsh20 and Mshai9\n");
  printf("We learned that git and GitHub are amazing, powerful tools!\n");
  printf("By Ali Alshaheen and Muhamamd Shaikah \n");
  printf("\nwe learnd how to clone repos, change them then push the changes back to the main repo.\n");
}
